<template>
  <div class="quiz-card result-page">
    <div class="quiz-stack">
      ...
      <div class="result-screen">
        <section class="result-showcase">
          <div class="result-showcase-main">
            ...
            <section class="result-hero">
              ...
              <div class="result-journey">
                ...
                <img class="result-journey-arc" :src="resultJourneyArc" alt="" loading="lazy" decoding="async" aria-hidden="true" />
          ...
          <aside class="result-showcase-aside" aria-hidden="true">
            <img class="result-showcase-photo" :src="resultShowcasePhoto" alt="" loading="lazy" decoding="async" />
          </aside>
        </section>
      ...
      <div v-if="showOpenPaywallCta" class="quiz-sticky-cta">
...
import type { ProgressCheckpointState, ResultInput, ResultProgram } from '../src/quiz/types'
...
const props = defineProps<{
  ...
  showOpenPaywallCta?: boolean
  onOpenPaywall: () => void
  onBack: () => void
}>()

const showOpenPaywallCta = computed(() => props.showOpenPaywallCta !== false)
...
const resultJourneyArc = assetUrl('/assets/quiz/result/duga.svg')
const resultShowcasePhoto = assetUrl('/assets/quiz/result/usmanova_result.webp')
