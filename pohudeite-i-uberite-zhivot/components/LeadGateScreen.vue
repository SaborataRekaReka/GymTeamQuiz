      ...
      <div class="quiz-stack">
        ...
        <div class="quiz-sticky-cta">
          <div class="quiz-actions">
            <Button class="quiz-open-result-pulse" label="Открыть результат" @click="onNext" />
          </div>
        </div>
      </div>
    </div>
...
import type { LeadGateAnswer, LegalLinks, ProgressCheckpointState, ValidationIssue } from '../src/quiz/types'
