  ...
  <div class="quiz-card">
    <div class="quiz-stack">
      ...
      <div v-if="isStart" class="quiz-brand">
        <img class="quiz-brand-photo" :src="assetUrl('/assets/quiz/hero/hero.jpg')" alt="Екатерина Усманова" />
      </div>
...
import type { LegalLinks, ProgressCheckpointState, QuizAnswersByScreen, QuizScreen, ValidationIssue } from '../src/quiz/types'
